...
Page({
  ...
  data: {
    ...
    sex: "男",
    age: 26,
    email: "darrenzhang1123@gmail.com",
    address: "宁夏回族自治区 - 银川市 - 北方民族大学",
    skill: [
      { name: "C++", percent: 85 },
      { name: "图像处理", percent: 90 },
      { name: "深度学习", percent: 90 },
  ...
  /**
    ...
    */
  onShow: function () {
    var width = wx.getSystemInfoSync().windowWidth // 屏幕宽度
    var height = wx.getSystemInfoSync().windowHeight // 屏幕宽度
